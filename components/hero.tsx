...
import { ArrowRight, Play, ExternalLink, X } from "lucide-react"
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
          <div className="relative w-full max-w-4xl mx-4">
            ...
            {/* Video container */}
            <div className="relative aspect-video bg-black rounded-lg overflow-hidden border-2 border-yellow-400/20">
              <video controls autoPlay className="w-full h-full" poster="/placeholder.svg?height=720&width=1280">
                <source
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/PMBC_Skate_Presentation_1-Kfns0K1qrbvHXJYyWwJvnHKp473UYa.mp4"
                  type="video/mp4"
                />
            ...
            <div className="mt-4 text-center">
              <h3 className="text-xl font-bold text-yellow-400">Prime Mates Board Club - Skate Presentation</h3>
              <p className="text-gray-300 mt-2">Experience the world of Prime Mates Board Club</p>
            </div>
          </div>
        </div>
      )}
